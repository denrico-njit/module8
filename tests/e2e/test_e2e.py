...
def test_calculator_add(page, fastapi_server):
    ...
    # wait until the result div has content (test was failing due to race condition)
    # kludge?
...
# Additional e2e tests for the calculator application
...
def test_calculator_divide(page, fastapi_server):
    ...
    page.fill('#b', '4')
    page.click('button:text("Divide")')
    assert page.inner_text('#result') == 'Calculation Result: 2.5'